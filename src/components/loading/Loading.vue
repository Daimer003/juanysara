<template>
  <div class="fixed inset-0 z-50 flex items-center justify-center bg-black">
    <div class="relative w-full max-w-[600px] h-screen flex items-center justify-center">
      ...
      <!-- Degradado superior -->
      <div
        class="absolute top-0 w-full h-1/5 bg-gradient-to-b from-black/90 via-black/60 to-transparent"
      ></div>

      <!-- Degradado inferior con texto -->
      <div
      ...
      >
        <h2
          class="text-white text-4xl font-playfair tracking-wide mb-3"
        >
          Juan & Sara
        </h2>
        <p
          class="text-white text-center font-cormorant italic text-xs max-w-[500px] px-4 mb-0"
        >
          Por eso dejará el hombre a su padre y a su madre, y se unirá a su
          mujer, y serán una sola carne. <br />
          <span class="text-xs opacity-80">— Génesis 2:24</span>
        </p>
      </div>
    </div>
  </div>
